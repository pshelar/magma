...
class GTPApplicationTest : public ::testing::Test {
 ...
 protected:
  virtual void SetUp() {
    ...
    controller->register_for_event(gtp_app, openflow::EVENT_DELETE_GTP_S8_TUNNEL);
  }
...
//   AddGTPTunnelEvent add_tunnel(
//       ue_ip, NULL, vlan, enb_ip, pgw_ip, in_tei, out_tei, imsi, enb_port, pgw_port);
//   // Uplink
//   EXPECT_CALL(
//       *messenger,
//       send_of_msg(
//           AllOf(
//               CheckTableId(0), CheckInPort(enb_port),
//               CheckTunnelId(in_tei), CheckCommandType(of13::OFPFC_ADD)),
//           _))
//       .Times(1);
//   // downlink
