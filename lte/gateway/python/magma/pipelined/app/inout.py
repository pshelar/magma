...
from ..bridge_util import DatapathLookupError
...
class InOutController(MagmaController):
    ...
    def _get_config(self, config_dict):
        ...
        try:
            if 'proxy_port_name' in config_dict:
                ...
                he_proxy_eth_mac = get_if_hwaddr(config_dict.get('proxy_port_name'))
    ...
    def _install_he_flows(self, dp):
        ...
        self.logger.info("he port: %s", self.config.he_proxy_port)
        parser = dp.ofproto_parser
