...
from magma.pipelined.openflow.registers import load_direction, Direction, \
    load_passthrough, set_proxy_tag, reset_in_port
...
class HeaderEnrichmentController(MagmaController):
    ...
    def get_subscriber_flows(self, ue_addr: str, ip_dst: str, rule_num,
    ...
    # pylint: disable=unused-argument
    def remove_subscriber_flow(self, ue_addr: str, rule_no):
        ...
        flows.delete_flow(self._datapath, self.tbl_num, match,
                          cookie=rule_no, cookie_mask=flows.OVS_COOKIE_MATCH_ALL)
